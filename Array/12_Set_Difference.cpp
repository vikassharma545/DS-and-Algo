...
public:
    ...
    Set_Operations *Difference_unsorted(Set_Operations s1, Set_Operations s2)
    {
    ...
    Set_Operations *Difference_Sorted(Set_Operations s1, Set_Operations s2)
    {
        int i = 0, j = 0, k = 0;
...
int main()
{
    ...
    s1.Display();
    s2.Display();
    s3 = s1.Difference_unsorted(s1, s2);
    s3 = s1.Difference_Sorted(s1, s2);
    s3->Display();
